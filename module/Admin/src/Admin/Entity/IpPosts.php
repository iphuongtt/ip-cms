 ...
 * IpPosts
 *
 * @ORM\Table(name="ip_posts", indexes={@ORM\Index(name="post_name", columns={"post_name"}), @ORM\Index(name="type_status_date", columns={"post_type", "post_status", "post_date", "ID"}), @ORM\Index(name="post_parent", columns={"post_parent"}), @ORM\Index(name="post_author", columns={"post_author"})})
 * @ORM\Entity
 */
class IpPosts
{
    ...
    /**
     * @var Login\Entity\IpUsers
     *
     * @ORM\Column(name="post_author", type="bigint", nullable=false)
     * @ORM\ManyToOne(targetEntity="Admin\Entity\IpUsers")
     * @ORM\JoinColumn(name="post_author", referencedColumnName="ID")
     * @Annotation\Filter({"name":"StringTrim"})
     * @Annotation\Validator({"name":"StringLength", "options":{"min":1, "max":100}})
     * @Annotation\Attributes({"type":"text"})
     * @Annotation\Options({"label":"Tác giả:","label_attributes":{"class":"col-sm-5 control-label"}})
    ),
     */
