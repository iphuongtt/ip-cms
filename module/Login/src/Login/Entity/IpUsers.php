 ...
 * @ORM\Entity(repositoryClass="Login\Entity\Repository\IpUsersRepository")
...
class IpUsers
{
     ...
     * @Annotation\Filter({"name":"StringTrim"})
     * @Annotation\Validator({"name":"StringLength"})
     * @Annotation\Attributes({"type":"text","class":"form-control","placeholder":"Tên đăng nhập"})
     * @Annotation\Options({"label":"Tên đăng nhập:","label_attributes":{"class":"col-sm-5 control-label"}})
     */
    private $userLogin = '';
     ...
     * @Annotation\Filter({"name":"StringTrim"})
     * @Annotation\Validator({"name":"StringLength"})
     * @Annotation\Attributes({"type":"text","class":"form-control focus","placeholder":"Mật khẩu"})
     * @Annotation\Options({"label":"Mật khẩu:","label_attributes":{"class":"col-sm-5 control-label"}})
     */
    private $userPass = '';
     ...
     * @Annotation\Options({"label":"Tên đầy đủ:","label_attributes":{"class":"col-sm-5 control-label"}})
     */
     ...
     * @Annotation\Validator({"name":"StringLength"})
     * @Annotation\Attributes({"type":"text","class":"form-control"})
     * @Annotation\Options({"label":"Địa chỉ Email:","label_attributes":{"class":"col-sm-5 control-label"}})
     */
    private $userEmail = '';
     ...
     * @Annotation\Validator({"name":"StringLength"})
     * @Annotation\Attributes({"type":"text","class":"form-control"})
     * @Annotation\Options({"label":"Url:","label_attributes":{"class":"col-sm-5 control-label"}})
     */
    private $userUrl = '';
     ...
     * @Annotation\Filter({"name":"StringTrim"})
     * @Annotation\Validator({"name":"StringLength"})
     * @Annotation\Options({"label":"Ngày đăng ký:","label_attributes":{"class":"col-sm-5 control-label"}})
